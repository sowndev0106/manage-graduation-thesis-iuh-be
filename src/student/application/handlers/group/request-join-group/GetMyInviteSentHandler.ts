...
@injectable()
export default class GetAllInviteJoinGroupHandler extends RequestHandler {
	...
	async handle(request: Request) {
		...
		const inviteJoinGroup = await this.requestJoinGroupDao.findAllByGroupIdAndType(group.id!, TypeRquestJoinGroup.REQUEST_INVITE);
