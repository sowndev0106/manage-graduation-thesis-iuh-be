...
container
  .bind<IGroupLecturerMemberDao>("GroupLecturerMemberDao")
  .to(GroupLecturerMemberDao);
container.bind<IAchievementDao>("AchievementDao").to(AchievementDao);
container
  .bind<INotificationLecturerDao>("NotificationLecturerDao")
  .to(NotificationLecturerDao);
